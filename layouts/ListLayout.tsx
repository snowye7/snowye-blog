...
export default function ListLayout({ posts, title, initialDisplayPosts = [], pagination }: ListLayoutProps) {
    ...
    return (
        <>
                ...
                <div className="space-y-2 pb-8 pt-6 md:space-y-5">
                    ...
                    <div className="relative max-w-lg">
                        <label>
                            ...
                            <input aria-label="Search articles" type="text" onChange={e => setSearchValue(e.target.value)} placeholder="Search articles" className="block w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-900 dark:bg-gray-800 dark:text-gray-100" />
                        </label>
            ...
            {pagination && pagination.totalPages > 1 && !searchValue && <Pagination currentPage={pagination.currentPage} totalPages={pagination.totalPages} />}
        </>
    )
}
